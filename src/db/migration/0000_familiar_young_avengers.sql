...
CREATE TABLE "guildVerificationSettings" (
	...
	"guildID" integer NOT NULL,
	"enabled" boolean DEFAULT false NOT NULL,
	"verifierRoleID" varchar(30) NOT NULL,
	"joinRoleID" varchar(30) NOT NULL,
	"assignJoinRole" boolean DEFAULT false NOT NULL,
	...
	"verificationInstructionMessageID" varchar(30) NOT NULL,
